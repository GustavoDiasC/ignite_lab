    ...
    <div className='w-screen h-screen bg-gray-900 flex items-center justify-center flex-col'>
      ...
      <footer className='flex flex-col items-center gap-4 mt-8'>
          <Text asChild size='sm'>
            <a href="" className='text-gray-400 underline hover:text-gray-400'>Esqueceu sua senha?</a>
          </Text>
          <Text asChild size='sm'>
            <a href="" className='text-gray-400 underline hover:text-gray-400'>Não possui conta? Crie uma agora</a>
          </Text>
      </footer>
    </div>
  )
